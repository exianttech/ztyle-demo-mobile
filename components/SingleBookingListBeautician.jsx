...
const SingleBookingList = ({ booking }) => {
    ...
    return (
        <View style={styles.listContainer}>
            <Text style={[styles.listTitle, styles.textSecondaryBeautician]}>Date : {dobookDay}-{monthdata[dobookMonth]}-{dobookYear}</Text>
            ...
            <View style={[styles.buttonContainer, { marginTop: 16 }]}>
                <TouchableOpacity
                    ...
                    onPress={() => router.push(`(screensBeautician)/CurrentBooking/${_id}`)}
                >
