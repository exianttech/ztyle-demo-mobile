...
import BeauticianReviews from './Reviews/BeauticianReviewsBeautician/BeauticianReviews';
import BeauticianModal from './Modals/BeauticianModal';
                    ...
                    <View style={styles.cardShadow}>
                        <View style={styles.cardBody}>
                            ...
                            <View style={{ marginBottom: 8 }}>
                                <Text style={[styles.cardBodySubHeading, styles.textSecondaryBeautician]}>Personal Information</Text>
                            </View>
                            <View style={[styles.serialRow, { marginBottom: 8 }]}>
                                <Text style={styles.fieldHeading}>Full Name</Text>
                                <Text style={styles.textSecondaryBeautician}> : </Text>
                            ...
                            {/* subsection */}
                            <View style={{ marginBottom: 8 }}>
                                <Text style={[styles.cardBodySubHeading, styles.textSecondaryBeautician]}>Basic Info</Text>
                            </View>
                            <View style={[styles.serialRow, { marginBottom: 8 }]}>
                        ...
                        <View style={styles.cardBody}>
                            {
                                ...
                                !advanceProfileStatus ? (
                                    <>
                                        <View style={{ marginBottom: 8 }}>
                                            <Text style={[styles.cardBodySubHeading, styles.textSecondaryBeautician]}>Time Slots For Booking : Working Day</Text>
                                        </View>
                                    ...
                                    <>
                                        ...
                                        <View style={styles.cardShadow}>
                                            <View style={styles.cardBody}>
                                                <Link href='/(formsBeautician)/AddAdvanceProfile'>
                ...
                return (
                    <View style={styles.cardShadow}>
                        <View style={styles.cardBody}>
                            ...
                            <View style={styles.cardBody}>
                                <View style={styles.alertContainer}>
                                    <View style={[styles.alert, styles.secondaryBeautician]}>
                                    ...
                                    <View style={styles.cardBody}>
                                        <View style={styles.alertContainer}>
                                            <View style={[styles.alert, styles.info]}>
                                                ...
                                                <Link href='/(formsBeautician)/EditBasicProfile'>
            ...
            >
                {
                    [
                        ...
                        <TouchableOpacity
                            ...
                            style={[styles.tab, activeTab === tab.key && styles.activeTabBeautician]}
                        >
                            <Text style={[styles.tabText, activeTab === tab.key && styles.activeTabTextBeautician]}>
                                {tab.label}
                            </Text>
                        </TouchableOpacity>
                    ))
