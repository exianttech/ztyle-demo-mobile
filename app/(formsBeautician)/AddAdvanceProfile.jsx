...
const AddAdvanceProfile = () => {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        <PageTitleBeautician activeMenu="Advance" motherMenu="Profile" />
            ...
            <View style={styles.cardShadow}>
              ...
              <View style={styles.cardBody}>
                ...
                <View style={{ marginBottom: 8 }}>
                  <Text style={[styles.cardBodySubHeading, styles.textSecondaryBeautician]}>Add Slots For Booking </Text>
                </View>
                {
                      ...
                      <View style={[styles.buttonContainer, { marginTop: 16 }]}>
                        ...
                        }
                        {
                          index === availableSlots.length - 1 && (
                            <TouchableOpacity
                              style={[styles.buttonLarge, styles.secondaryBeautician,{marginLeft:8}]}
