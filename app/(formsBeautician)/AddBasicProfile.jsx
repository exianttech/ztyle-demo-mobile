...
import FloatingBackButton from '@/components/FloatingBackButtonBeautician';
import DatePickerInput from '@/components/DatePickerInputBeautician';
...
const AddBasicProfile = () => {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        <PageTitleBeautician activeMenu="Basic" motherMenu="Profile" />
