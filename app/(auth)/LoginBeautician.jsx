import { View, ScrollView, Text, KeyboardAvoidingView, Platform, Image, TextInput, TouchableOpacity } from 'react-native';
        ...
        <View style={[{ paddingVertical: 24 }, styles.authBackground]}>
          ...
          <View style={styles.authFormContainer}>
            ...
            <Text style={[styles.textGray,{marginTop:16}]}>
              forgot password?{" "}
              <Link href='/(auth)/ForgotPasswordBeautician'>
                <Text style={styles.textSecondaryBeautician}> Click to Reset Your Password</Text>
              </Link>
            </Text>
            ...
            <Text style={styles.textGray}>
              ...
              <Link href='/(auth)/RegisterBeautician'>
                <Text style={styles.textSecondaryBeautician}> Sign up</Text>
              </Link>
            </Text>
