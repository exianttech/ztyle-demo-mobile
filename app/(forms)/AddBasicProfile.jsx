...
const AddBasicProfile = () => {
    ...
    const handleSubmit = () => {
        ...
        const profileData = { fullName, email, gender, dob, mobile };
    ...
    useEffect(() => {
        if (success) {
            showMessage({
                message: "Profile Added Successfuly",
                type: 'success'
            })
                ...
                <View style={[styles.center, { flex: 1 }]}>
                    <View style={styles.centerAlertContainer}>
                        <View style={[styles.alert, styles.warning]}>
                            <Text style={[styles.alertText, styles.alertTextBold]}>profile exists already !!!  </Text>
                                <Link href='/(forms)/EditBasicProfile' >
                                <Text style={styles.alertText}>please edit your profile </Text>
                            </Link>
                        </View>
                    </View>
                </View>
