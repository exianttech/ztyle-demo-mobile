...
const MyShopReview = () => {
    ...
    useFocusEffect(
        useCallback(() => {
            dispatch(getMyShopReview({ searchData: { shopId: id, userId: userInfo._id } }))
        }, [dispatch, id, userInfo])
    );
    
    // review states
    const { loading, currentShopReview, error, success } = useSelector(state => state.review);
    ...
    const handleSubmit = () => {
        ...
        if (currentShopReview) {
            dispatch(editShopReviewById({ reviewData, id: currentShopReview._id, }))
        }
        else {
            dispatch(addShopReview({ reviewData}))
        }
    }
                    ...
                    <View style={{ paddingVertical: 16, flex: 1 }}>
                            ...
                            <View style={styles.column}>
                                <View style={[styles.card, { marginTop: 8 }]}>
                                    <View style={[styles.cardBody, styles.center]}>
                                        <Text style={[styles.largeHeading, styles.textSecondary, styles.textCenter]}>Rating And Review Of Shop</Text>
                                        <Text style={[styles.textInfo, styles.textCenter]}>You Have Already Submitted A Review To This Shop. Edit The Review</Text>
                                    </View>
                                </View>
                            </View>
                        </View>
                        <View style={styles.row}>
                            <View style={styles.column}>
                                <View style={[styles.card, { marginTop: 8 }]}>
                                    ...
                                    <View style={styles.cardBody}>
                                        <Text style={[styles.textGray, { marginBottom: 16 }]}>We can understand the experience you have obtained from this shop.</Text>
                                        <Text style={styles.textGray}>This will enable us to improve the service offered to you.</Text>
                                    </View>
                                    <View style={[styles.cardHeader]}>
                                        <Text style={styles.subHeading}>How To Review A Shop</Text>
                                    </View>
                                    <View style={styles.cardBody}>
                            ...
                            <View style={styles.column}>
                                <View style={[styles.card, { marginTop: 8 }]}>
                                    <View style={[styles.cardHeader]}>
                                        <Text style={styles.subHeading}>Please Rate This Shop</Text>
                                    </View>
                                    <StarRating
                                        rating={rating}
                                        setRating={setRating}
                                    ...
                                    />
                                    <View style={[styles.cardHeader]}>
                                        <Text style={styles.subHeading}>Please Review This Shop</Text>
                                    </View>
                                    <TextInput
                        ...
                        <View style={styles.row}>
                            <View style={styles.column}>
                                <View style={[styles.card, { marginTop: 8 }]}>
                                    <View style={[styles.cardBody, styles.center]}>
                                        <Text style={[styles.largeHeading, styles.textSecondary, styles.textCenter]}>Rating And Review Of Shop</Text>
                                        <Text style={[styles.textInfo, styles.textCenter]}>You Haven't Submit Any Review To This Shop. Add A Review</Text>
                                    </View>
                                </View>
                            </View>
                        </View>
